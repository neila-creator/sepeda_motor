...
import 'data_alat_screen.dart' as alat;                  // prefix alat untuk DataAlatScreen
import 'data_peminjaman_screen.dart' as peminjaman;     // prefix peminjaman untuk DataPeminjamanScreen
...
class _DashboardSharedState extends State<DashboardShared> {
  ...
  void initState() {
    ...
    _pages = [
      ...
      const alat.DataPeminjamanScreen(),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: _statCard(Icons.build_rounded, Colors.blue, '10', 'Total Alat')),
              const SizedBox(width: 12),
              Expanded(child: _statCard(Icons.check_circle_rounded, Colors.green, '5', 'Tersedia')),
              const SizedBox(width: 12),
              Expanded(child: _statCard(Icons.autorenew_rounded, Colors.orange, '5', 'Transaksi')),
            ],
          ),
